            ...
            <Navbar bg="dark" variant="dark" style={{ height: "60px"}} sticky="top">
                ...
                >
                {
                   ...
                   <div className='card_details d-flex justify-content-center align-items-center' style={{width:"24rem",padding:10,position:"relative"}}>
                    ...
                    <img src={"https://img.pikbest.com/png-images/20191028/push-shopping-cart-to-woman-gif_2515298.png!bw700"} alt="" className='emptycart_img' style={{width:"3rem",padding:10}} />
                   </div>
                    }
